    ...
    try {
      ...
      if (existing) {
        const patched: Candidate = {
          ...
          current_salary: existing.current_salary || intake.currentSalary,
          availability: existing.availability || intake.availability,
          confirm_relocate_oman: existing.confirm_relocate_oman ?? intake.confirmRelocateOman,
          confirm_gcc_experience: existing.confirm_gcc_experience ?? intake.confirmGccExperience,
          confirm_valid_passport: existing.confirm_valid_passport ?? intake.confirmValidPassport,
        ...
        const candidate: Candidate = {
          ...
          current_salary: intake.currentSalary,
          availability: intake.availability,
          confirm_relocate_oman: intake.confirmRelocateOman,
          confirm_gcc_experience: intake.confirmGccExperience,
          confirm_valid_passport: intake.confirmValidPassport,
          ai_score: 60,
          ai_strengths: [],
          ai_concerns: [],
          recommended_roles: [],
